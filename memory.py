...
questions_list = []
questions_list.append(Question('В каком году родился Аль-Хорезми?', '783', '971', '865', '1995'))
questions_list.append(Question('Какая самая быстрая машина в мире', 'Bugatti Chiron', 'Bugatti Veyron', 'Pagani', 'Venom'))
questions_list.append(Question('Сколка истребителелий в Узбекистан?', '450', '115', '250', '10'))
...
btn_ok.setStyleSheet("background-color: while;"
                    "color:yellow;")
...
def check_answer():
    if answers[0].isChecked():
        ...
        main_win.score += 1
        print("Статистика:\n Всегдо вопросов задано:", main_win.total,  "\nВерных ответов:", main_win.score)
